...
<%
	...
	dto = dao.updateMember(member_id2, dto);
%>
...
<table>
    <tr>
        <td>아이디</td><td><input type="text" name="member_id" value="<%=dto.getMember_id() %>"></td>
    </tr>
    <tr>
        <td>비밀번호</td><td><input type="password" name="member_pw" value="<%=dto.getMember_pw() %>"></td>
    </tr>
    <tr>
        <td>이름</td><td><input type="text" name="member_name" value="<%=dto.getMember_name() %>"></td>
    </tr>
    <tr>
        <td>전화번호</td><td><input type="text" name="phone_no" value="<%=dto.getPhone_no() %>"></td>
    </tr>
</table>
